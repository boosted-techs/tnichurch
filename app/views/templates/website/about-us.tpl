...
{block name="body"}
    ...
    <section class="banner position-relative">
        ...
        <div class="banner-data text-center">
            ...
            <img src="/assets/images/tni.png" alt="Banner Logo" style="object-fit: contain">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="content">
                        ...
                        <h2>Welcome to SKCF</h2>

                        <p class="w-85">In ancient day Africa child upbringing was a primary responsibility of every member of the community. This was a tool of securing and ensuring continuity of communal values, norms and practices. However, with the changing trends in development and civilization, that very core aspect has been undermined and replaced with broken families, busy parents, neglected children and the ever-present demand for survival. This is mostly evidenced in slum areas in Uganda where such neglect has bred evils like crime, drug abuse, among other evils.</p>
                        ...
                        <div class="sidetwo">
							...
							<span class="icon">
                                ...
                                <ul>
                                    ...
                                    <li><p class="theme-clr">To empower slum dwellers to initiate, participate and contribute to the economic and social development of their respective slum communities.</p></li>
							...
							<span class="icon">
                                ...
                                <ul>
                                    ...
                                    <li><p>Vision</p></li>
                                    <li><p class="theme-clr">
                                            To advocate, inspire, initiate and contribute to models that can transform slum communities around the river Nile Basin into economically and socially empowered communities.
                                        </p></li>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="content">
                        ...
                        <p class="mt-4 mb-4">
                            Therefore, Senga Kulabako Community foundation’s mandate remedies the statuesque. This is an organization formed by dynamic members with the major aim of restoring slum community discipline as regards child grooming as well as economic development. The objectives of the organization are as stated below;
                        </p>
                        <ol>
                            <li>
                                <p class="theme-clr">1. To provide a platform to discuss children grooming methods.</p>
                            </li>
                            <li>
                                <p class="text-orange">2. To foster communal responsibility in children upbringing.</p>
                            </li>
                            <li>
                                <p class="theme-clr">3. To provide a medium through which small scale businesses can flourish.</p>
                            </li>
                            <li>
                                <p class="text-blue">4. To foster community empowerment and development.</p>
                            </li>
                            <li>
                                <p class="theme-clr">5. To strengthen the social fabric.</p>
                            </li>
                            <li>
                                <p class="text-blue">6. To increase and create employment opportunities.</p>
                            </li>
                            <li>
                                <p class="theme-clr">7. To improve the quality of life of people in slums.</p>
                            </li>
                            <li>
                                <p class="text-blue">8. To harness talent, creativity and innovation.</p>
                            </li>
                            <li>
                                <p class="theme-clr">9. To increase community participation in solving and finding solutions to slum community problems.</p>
                            </li>
                            <li>
                                <p class="text-blue">10. To curb crime.</p>
                            </li>
                            <li>
                                <p class="theme-clr">11. To open up slum areas to opportunities of investment, strengthening and budget planning.</p>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="pray-data text-center">
                    ...
                    <img src="/assets/images/tni.png" style="width: 180px;" alt="Pray Img">

                    <h2 class="m-auto text-white">“We are an organization formed by dynamic members with the major aim of of restoring slum community discipline as regards child grooming as well as economic development</h2>

                    <p class="text-white font-bold">--Senga Kulabako Community Foundation--</p>
...
{*                            <a class="font-bold text-white" href="pastor-detail.html">##</a>*}
