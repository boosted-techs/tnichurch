                        ...
                        <div class="col-xl-12">
                            <div class="auth-form">
                                <div class="text-center mb-3">
                                    <a href="/wp-admin"><img src="/assets/images/tni.webp" alt="Logo"></a>
                                </div>
                                <h4 class="text-center mb-4 text-white">Sign in your account</h4>
                                <form action="/wp-admin/sign-in" method="post">
                                    ...
                                    <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                        ...
                                        <div class="form-group">
                                            <a class="text-white" href="/wp-admin/forgot-pwd">Forgot Password?</a>
                                        </div>
                                    </div>
